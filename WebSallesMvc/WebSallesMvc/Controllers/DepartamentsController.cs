...
namespace WebSallesMvc.Controllers
{
    public class DepartamentsController : Controller
    {
        private readonly WebSallesMvcContext _context;

        public DepartamentsController(WebSallesMvcContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Departament != null ? 
                          ...
                          Problem("Entity set 'WebSallesMvcContext.Departament'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebSallesMvcContext.Departament'  is null.");
            }
            var departament = await _context.Departament.FindAsync(id);
            if (departament != null)
            {
